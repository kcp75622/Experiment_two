...
/**
* @brief The Change_Counter_Speed adjusts the speed of the counter base on the buttons.
*
* This function reads the button when pushed it will increment the speed of the counter.
* It will implement the counter's speed which will increment the number from 0 to 15, then
* going back to 0 and incrementing again. 
*
* @param None
*
* @return Indicates the result of the buttons. 
*/
